    ...
    public class AutoAuthenticationMiddleware {
        ...
        private HttpRequestMessage GetTokenRequestMessage(DiscoveryDocumentResponse disco,
            ...
            var parameters = new List<KeyValuePair<string, string>> {
                        ...
                        KeyValuePair.Create("client_id",_oidcOptions.ClientId),
                        KeyValuePair.Create("redirect_uri",_oidcOptions.RedirectUri)
                    };
            if (_oidcOptions.ClientSecret != null)
                parameters.Add(KeyValuePair.Create("client_secret", _oidcOptions.ClientSecret));
