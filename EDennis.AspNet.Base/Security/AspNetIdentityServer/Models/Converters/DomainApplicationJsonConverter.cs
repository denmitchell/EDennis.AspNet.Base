...
namespace EDennis.AspNet.Base.Security {
    ...
    public class DomainApplicationJsonConverter : JsonConverter<DomainApplication> {
        ...
        public static void DeserializeInto(DomainApplication obj, HttpRequest request) {
        ...
        public static void DeserializeInto(DomainApplication obj, Utf8JsonReader reader) {
