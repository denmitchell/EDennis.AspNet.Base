...
namespace EDennis.AspNet.Base.Security {
    ...
    public class DomainUserClaimJsonConverter : JsonConverter<DomainUserClaim> {
        ...
        public static void DeserializeInto(DomainUserClaim obj, HttpRequest request) {
        ...
        public static void DeserializeInto(DomainUserClaim obj, Utf8JsonReader reader) {
                ...
                switch (reader.TokenType) {
                    case JsonTokenType.PropertyName:
                        ...
                        switch (prop) {
                            ...
                            case "ClaimType":
                            case "claimType":
                                obj.ClaimType = reader.GetString();
                                break;
                            case "ClaimValue":
                            case "claimValue":
                                obj.ClaimValue = reader.GetString();
                                break;
                            case "SysUser":
                            case "sysUser":
