...
namespace EDennis.NetStandard.Base {
    public interface IQueryApiClient<TEntity> where TEntity : class {
        ...
        ObjectResult<DeserializableLoadResult<TEntity>> GetWithDevExtreme(string select, string sort, string filter, int skip, int take, string totalSummary, string group, string groupSummary);
        Task<ObjectResult<DeserializableLoadResult<TEntity>>> GetWithDevExtremeAsync(string select, string sort, string filter, int skip, int take, string totalSummary, string group, string groupSummary);
