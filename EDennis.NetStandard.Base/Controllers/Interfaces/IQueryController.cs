...
namespace EDennis.NetStandard.Base {
    public interface IQueryController<TEntity> where TEntity : class {
        ...
        IActionResult GetWithDevExtreme([FromQuery] string select, [FromQuery] string include, [FromQuery] string sort, [FromQuery] string filter, [FromQuery] int skip, [FromQuery] int take, [FromQuery] string totalSummary, [FromQuery] string group, [FromQuery] string groupSummary);
        Task<IActionResult> GetWithDevExtremeAsync([FromQuery] string select, [FromQuery] string include, [FromQuery] string sort, [FromQuery] string filter, [FromQuery] int skip, [FromQuery] int take, [FromQuery] string totalSummary, [FromQuery] string group, [FromQuery] string groupSummary);
