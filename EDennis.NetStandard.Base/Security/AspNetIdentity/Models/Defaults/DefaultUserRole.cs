...
namespace EDennis.NetStandard.Base {
    public class DefaultUserRole : TeUserRole<DefaultUser, DefaultOrganization, DefaultUserClaim, DefaultUserLogin, DefaultUserToken, DefaultRole, DefaultApplication, DefaultRoleClaim, DefaultUserRole> {
