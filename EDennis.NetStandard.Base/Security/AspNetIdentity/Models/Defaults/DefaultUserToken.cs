...
namespace EDennis.NetStandard.Base {
    public class DefaultUserToken : TeUserToken<DefaultUser, DefaultOrganization, DefaultUserClaim, DefaultUserLogin, DefaultUserToken, DefaultRole, DefaultApplication, DefaultRoleClaim, DefaultUserRole> {
