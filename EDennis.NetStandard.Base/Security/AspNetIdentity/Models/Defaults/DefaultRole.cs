...
namespace EDennis.NetStandard.Base {
    public class DefaultRole : TeRole<DefaultUser, DefaultOrganization, DefaultUserClaim, DefaultUserLogin, DefaultUserToken, DefaultRole, DefaultApplication, DefaultRoleClaim, DefaultUserRole> {
