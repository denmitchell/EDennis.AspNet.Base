...
namespace EDennis.NetStandard.Base {
    public class DefaultUserLogin: TeUserLogin<DefaultUser, DefaultOrganization, DefaultUserClaim, DefaultUserLogin, DefaultUserToken, DefaultRole, DefaultApplication, DefaultRoleClaim, DefaultUserRole> {
