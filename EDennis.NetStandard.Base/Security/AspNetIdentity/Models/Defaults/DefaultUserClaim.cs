...
namespace EDennis.NetStandard.Base {
    public class DefaultUserClaim : TeUserClaim<DefaultUser, DefaultOrganization, DefaultUserClaim, DefaultUserLogin, DefaultUserToken, DefaultRole, DefaultApplication, DefaultRoleClaim, DefaultUserRole> {
